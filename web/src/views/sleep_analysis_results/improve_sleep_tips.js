    ...
    <ul className="list-unstyled mt-4">
      ...
      <li className="py-2">
        <BadgeBulletPoint badgeColor="warning" iconClass="far fa-calendar-alt">
          <h6 className="mb-0">
            Routine: going to sleep at about the same time, in a dark and quiet environment can help stabilize your
      ...
      <li className="py-2">
        <BadgeBulletPoint badgeColor="warning" iconClass="fas fa-running">
          <h6 className="mb-0">Exercise: work out for 20 to 30 minutes each day and maintain an active lifestyle.</h6>
        </BadgeBulletPoint>
      </li>
    </ul>
  </>
