  ...
  <section className="section mt-4">
    <Container>
      ...
      <p className="lead text-justify">
        ...
        153 nights of polysomnographic recordings. The machine learning approach we used achieves a 87% accuracy when
        ...
        algorithms can achieve an accuracy as high as 93% [Fiorillo et al., 2019]. Using brainwaves data, we were able
